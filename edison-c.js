...
function initTasks(gulp, options) {
  ...
  gulp.task('clone-iot-sdk', false, function (cb) {
    all.sshExecCmds(["if [ ! -d ~/azure-iot-sdks ]; then git clone https://github.com/Azure/azure-iot-sdks.git && git checkout a291a82; fi",
      ...
      'cd ~/azure-iot-sdks/c/c-utility && if ! [ "$(ls -A .)" ]; then git clone https://github.com/Azure/azure-c-shared-utility.git . && git checkout d42faec; fi',
      'cd ~/azure-iot-sdks/c/uamqp/c-utility && if ! [ "$(ls -A .)" ]; then git clone https://github.com/Azure/azure-c-shared-utility.git . && git checkout 749fdbd; fi',
      'cd ~/azure-iot-sdks/c/umqtt/c-utility && if ! [ "$(ls -A .)" ]; then git clone https://github.com/Azure/azure-c-shared-utility.git . && git checkout 749fdbd; fi'],
      {
